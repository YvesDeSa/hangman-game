...
public class Application {
  private final static String[] FACTORY_REPOSITORY_TYPES = { "memoria", "relacional" };
  private final static String[] TYPES_GRAPHIC_ELEMENT_FACTORY = { "texto", "imagem" };
  private final static String[] ROUND_TYPE_FACTORY = { "sorteio" };
